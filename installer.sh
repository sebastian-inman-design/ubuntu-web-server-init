...
Welcome() {
  ...
  echo ""
  echo -e "${CLR_RESET}"
  echo -e "${CLR_GREEN}    EEEEEEEEEEEEEEEEEE EEEEEEEEEEEEEEEEEEE"
  echo -e "${CLR_GREEN}    EEEEEEEEEEEEEEEEE   EEEEEEEEEEEEEEEEEE"
  echo -e "${CLR_GREEN}    EEEE                              EEEE    ${CLR_WHITE}Welcome to the Seeds CS WordPress Installer!"
  echo -e "${CLR_GREEN}    EEEE                              EEEE    ${CLR_WHITE}Created by Sebastian Inman <${CLR_CYAN}sebastian@seedscs.com${CLR_WHITE}>"
  echo -e "${CLR_GREEN}    EEEEEEEEEEEE              EEEEEEEEEEEE"
  echo -e "${CLR_GREEN}    EEEEEEEEEEEE              EEEEEEEEEEEE    ${CLR_WHITE}This script will automatically install and configure"
  echo -e "${CLR_GREEN}    EEEE                              EEEE    ${CLR_WHITE}a full-featured Nginx server with PHP, MySQL, fail2ban"
  echo -e "${CLR_GREEN}    EEEE                              EEEE    ${CLR_WHITE}and many other common packages. It will then install the"
  echo -e "${CLR_GREEN}    EEEEEEEEEEEEEEEEE   EEEEEEEEEEEEEEEEEE    ${CLR_WHITE}latest version of WordPress."
  echo -e "${CLR_GREEN}    EEEEEEEEEEEEEEEEEE EEEEEEEEEEEEEEEEEEE"
  echo -e "${CLR_RESET}"
  echo ""
